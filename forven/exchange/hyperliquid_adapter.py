...
log = logging.getLogger("forven.exchange.hyperliquid_adapter")
...
class HyperliquidExchange(ExchangeInterface):
    ...
    async def get_account_value(self) -> float:
        ...
        from forven.exchange.hyperliquid import get_account_value as hl_get_account_value
    ...
    async def get_positions(self) -> List[Position]:
        ...
        from forven.exchange.hyperliquid import get_positions as hl_get_positions
