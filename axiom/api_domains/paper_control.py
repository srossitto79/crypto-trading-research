...
from axiom.db import get_db, kv_get, next_container_id
from axiom.exchange import books as books_mod
...
def _live_vault_for_trade(trade: dict) -> str | None:
    ...
    """
    from axiom.scanner import _resolve_trade_vault_address
...
def _live_open(
    ...
    try:
        from axiom.scanner import _update_trade_fill
