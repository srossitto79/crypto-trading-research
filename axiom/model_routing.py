...
log = logging.getLogger("axiom.model_routing")
...
_MODEL_ROUTING_STORAGE_KEY = "axiom:model-routing"
...
def _provider_has_credentials(provider: str) -> bool:
    ...
    ``Axiom.ai._provider_has_credentials``). Lazy import to avoid a cycle —
    ``Axiom.ai`` imports this module at load time.
    """
    try:
