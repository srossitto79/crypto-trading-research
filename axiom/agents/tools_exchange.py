...
from axiom.db import get_db, kv_get, log_activity
...
def _tool_request_fix(params: dict) -> str:
    ...
    try:
        from axiom.brain import escalate_to_engineer
...
async def _tool_place_order(params: dict) -> str:
    ...
    from axiom.agents.trade_safeguards import TradeSafeguards, MarketRegime
...
def _tool_cancel_orders(asset: str | None = None) -> str:
    ...
    from axiom.exchange.hyperliquid import cancel_all_orders
