...
from axiom import brain_memory as _brain_memory
...
def _tool_create_strategy(params: dict) -> str:
    ...
    from axiom.agents.tools_research import assert_hypothesis_spawn_allowed
...
def _tool_factory_reset(params: dict) -> str:
    ...
    from axiom.db import factory_reset, FACTORY_RESET_CATEGORIES
...
def _tool_recall_similar_situation(params: dict) -> str:
    """Brain-only recall tool — wraps :func:`Axiom.recall.recall_similar_situation`."""
    from axiom.recall import recall_similar_situation
...
def _tool_propose_skill_update(params: dict) -> str:
    ...
    from axiom.db import create_approval
...
def _tool_create_routine(params: dict) -> str:
    ...
    """
    from axiom.control_plane.routines import RoutineValidationError, _validate_cron, _validate_context, get_routine_by_name
    from axiom.db import create_approval
