...
log = logging.getLogger("axiom.sandbox")
...
def run_code(
    ...
    if IS_WINDOWS:
        ...
        # passes every secret-bearing var (ANTHROPIC_API_KEY, AXIOM_HL_API_SECRET,
        # AXIOM_ENCRYPTION_KEY, …) straight into AI-generated / prompt-injectable
