...
def _build_isolated_env(bot_config: dict) -> dict[str, str]:
    ...
    Passes AXIOM_HOME, BOT_ID, minimal system vars, the ChromaDB in-process
    ...
    for guard_var in (
        "AXIOM_DISABLE_CHROMA_IN_PROCESS",
        "AXIOM_DISABLE_CHROMA",
    ...
    try:
        from axiom.auth.store import _ENV_ACCESS_TOKEN_KEYS, _ENV_BASE_URL_KEYS
    ...
    # credential lives on-disk (AXIOM_HOME, already forwarded) still has a key
...
class BotManager:
    ...
    def start_bot(self, bot_id: str) -> dict:
        ...
        try:
            process = subprocess.Popen(
                [
                    sys.executable, "-m", "axiom.bot_factory.runner",
                    "--bot-id", bot_id,
    ...
    def stop_bot(self, bot_id: str, timeout: float = 5.0) -> dict:
        ...
        if process and process.poll() is None:
            ...
            from axiom.db import get_bot_status as _get_status
            ...
            if pid == os.getpid():
                ...
                try:
                    ...
                    try:
                        ...
                        # so a recycled PID that's merely some other Axiom process
                        # is never killed.
                        looks_like_this_bot = (
    ...
    def _reconcile_orphans(self) -> None:
        ...
        from axiom.db import get_db, reconcile_orphaned_bot_trades
