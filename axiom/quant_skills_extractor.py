...
log = logging.getLogger("axiom.quant_skills_extractor")
...
def _extract_and_store(backtest_result: dict) -> None:
    ...
    try:
        from axiom.vectordb import search_quant_skills, upsert_quant_skill
        ...
        if insight["action"] == "update_skill" and insight.get("skill_name"):
            ...
            if h.count >= PROMOTION_THRESHOLD:
                from axiom.quant_skills import promote_hypothesis
