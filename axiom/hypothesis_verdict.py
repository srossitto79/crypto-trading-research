...
from axiom.hypotheses import get_hypothesis, update_hypothesis_status
...
def _call_llm(prompt: str) -> str:
    """Thin wrapper so tests can mock without importing Axiom.ai machinery."""
    from axiom.ai import call_ai_sync, resolve_available_provider
