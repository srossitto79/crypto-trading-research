...
Phase 5 / P5-T02: SSRF helpers moved to ``Axiom.security.url_safety`` so
...
from axiom.security.url_safety import (  # noqa: F401 (re-exported for callers/tests)
    UnsafeUrlError,
...
USER_AGENT = "Axiom-research-sources/1.0 (+https://github.com/srossitto79/axiom)"
