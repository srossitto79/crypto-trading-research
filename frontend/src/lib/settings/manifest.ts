...
const DATA_ENGINE_STREAM_OPTIONS = [
  { value: 'candles', label: 'Candles' },
  { value: 'funding', label: 'Funding' },
  { value: 'oi', label: 'Open interest' },
  { value: 'lsr', label: 'Long/short ratio' },
  { value: 'taker', label: 'Taker volume' },
...
const DATA_ENGINE_ENRICHMENT_OPTIONS = [
  { value: 'funding', label: 'Funding' },
  { value: 'oi', label: 'Open interest' },
  { value: 'lsr', label: 'Long/short ratio' },
  { value: 'taker', label: 'Taker volume' },
  ...
  { value: 'treasury_10y', label: 'Treasury 10Y' },
  { value: 'spy', label: 'SPY' },
];
...
export const SETTINGS_SUBSECTIONS: SettingsSubsection[] = [
  ...
  // Data
  { id: 'data-engine-core', area: 'data', label: 'Data Engine', description: 'Local-first DuckDB catalog, source priority, streaming, retention, and validation policy.', deepLinkTo: '/data' },
];
...
export const SETTINGS_MANIFEST: SettingsEntry[] = [
  ...
  },
  {
    ...
    default: ['candles', 'funding', 'oi'],
    type: 'csv',
    options: DATA_ENGINE_STREAM_OPTIONS,
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.streams',
    description: 'Data stream names eligible for collection and live monitoring.',
    usedBy: ['forven.dataeng.settings', 'forven.dataeng.stream'],
  },
  {
  ...
  {
    id: 'data-engine.symbol_universe_scope',
    label: 'Symbol universe scope',
    default: 'active',
    type: 'select',
    options: [
      { value: 'active', label: 'Active strategies' },
      { value: 'watchlist', label: 'Active + watchlist' },
      { value: 'custom', label: 'Custom list' },
    ],
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.symbol_universe_scope',
    description: 'Symbol set used by streaming and catch-up planning.',
    usedBy: ['forven.dataeng.settings', 'forven.dataeng.catchup'],
  },
  {
    id: 'data-engine.custom_symbols',
    ...
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.custom_symbols',
    description: 'Explicit symbol list when the Data Engine universe scope is custom.',
    usedBy: ['forven.dataeng.settings'],
  },
  {
    id: 'data-engine.backfill_aggressiveness',
    label: 'Backfill aggressiveness',
    default: 'balanced',
    type: 'select',
    options: [
    ...
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.backfill_aggressiveness',
    description: 'How eagerly catch-up planning should request historical recovery.',
    usedBy: ['forven.dataeng.settings', 'forven.dataeng.catchup'],
  },
  {
    id: 'data-engine.max_history_days',
    label: 'Max history',
    unit: 'days',
    default: 3650,
    type: 'number',
    ...
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.max_history_days',
    description: 'Maximum historical window a source adapter should request.',
    usedBy: ['forven.dataeng.settings', 'forven.dataeng.ccxt_source'],
  },
  {
    id: 'data-engine.stream_buffer_limit',
    label: 'Stream buffer limit',
    default: 10000,
    type: 'number',
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.stream_buffer_limit',
    description: 'Maximum rows kept in each live stream buffer before oldest rows are dropped.',
    usedBy: ['forven.dataeng.stream'],
  },
  {
    id: 'data-engine.microstructure_raw_window_days',
    label: 'Microstructure raw window',
    unit: 'days',
    default: 14,
    type: 'number',
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.microstructure_raw_window_days',
    description: 'Days of raw trades/orderbook data to retain before roll-up or discard.',
    usedBy: ['forven.dataeng.microstructure', 'forven.dataeng.settings'],
  },
  {
    id: 'data-engine.microstructure_retention_mode',
    label: 'Microstructure retention',
    default: 'rollup',
    type: 'select',
    options: [
    ...
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.microstructure_retention_mode',
    description: 'What happens to raw microstructure data after the raw retention window.',
    usedBy: ['forven.dataeng.microstructure', 'forven.dataeng.settings'],
  },
  {
  ...
  {
    id: 'data-engine.validation_policy',
    label: 'Validation policy',
    default: 'flag_priority',
    type: 'select',
    options: [
      { value: 'off', label: 'Off' },
    ...
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.validation_policy',
    description: 'How cross-source bar divergences are flagged and resolved.',
    usedBy: ['forven.dataeng.validation', 'forven.dataeng.settings'],
  },
  {
    id: 'data-engine.gap_auto_repair',
    label: 'Gap auto-repair',
    default: true,
    type: 'toggle',
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.gap_auto_repair',
    description: 'Allow startup catch-up planning to schedule recoverable Tier-1 gaps.',
    usedBy: ['forven.dataeng.catchup', 'forven.scheduler'],
  },
  {
    id: 'data-engine.max_auto_backfill_days',
    label: 'Max auto-backfill',
    unit: 'days',
    default: 30,
    type: 'number',
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.max_auto_backfill_days',
    description: 'Maximum recoverable window startup catch-up may auto-plan.',
    usedBy: ['forven.dataeng.catchup', 'forven.dataeng.settings'],
  },
  {
  ...
  {
    id: 'data-engine.default_enrichments',
    label: 'Default enrichments',
    default: ['funding', 'oi'],
    type: 'csv',
    options: DATA_ENGINE_ENRICHMENT_OPTIONS,
    area: 'data',
    subsection: 'data-engine-core',
    backendSection: 'data-engine',
    backendPath: 'data_engine_settings.default_enrichments',
    description: 'Default enrichment streams attached to DataHub candle reads.',
    usedBy: ['forven.dataeng.hub', 'forven.dataeng.settings'],
  },
  {
